...
status_t sendMetaDataToHal_QC(const sp<MetaData>& meta, AudioParameter *param) {
    ...
    if (meta->findData(kKeyRawCodecSpecificData, &type, &data, &size)) {
        ...
        AVLOGV("Found kKeyRawCodecSpecificData of size %d", size);
                           ...
                           const sp<MetaData>& meta)
{
    ...
    sendMetaDataToHal_QC(meta, &param);
...
bool mapAACProfileToAudioFormat_QC(const sp<MetaData> &meta,
                      ...
                      bool isStreaming, audio_stream_type_t streamType)
{
    ...
    if (meta->findInt32(kKeyAACAOT, &aacaot)) {
        ...
        isADTSSupported = mapAACProfileToAudioFormat_QC(meta, info.format,
