...
LOCAL_SRC_FILES_$(TARGET_ARCH) += AudioResamplerQTI.cpp.arm
LOCAL_C_INCLUDES_$(TARGET_ARCH) += $(TARGET_OUT_HEADERS)/mm-audio/audio-src
LOCAL_SHARED_LIBRARIES_$(TARGET_ARCH) += libqct_resampler
LOCAL_CFLAGS_$(TARGET_ARCH) += -DQTI_RESAMPLER
endif
endif
endif
#QTI Resampler
